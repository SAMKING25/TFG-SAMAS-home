...
<head>
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=AZiNIbkuxCM_s2y_iYwPg7V4zhQKzZbSJhN_y0P7_Pl5hDT7l3bAdsy8VoRzicjIA7r3JnzwT8e_TTJK&currency=EUR"></script>
</head>
    ...
    <script>
        paypal.Buttons({
            ...
            onApprove: function (data, actions) {
                actons.order.capture().then(function (detalles) {
                    windows.location.href = "completado.html";
                });
            },
