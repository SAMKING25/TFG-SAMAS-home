                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="login-links">
                                            <p>
                                                ...
                                                ¿Eres un usuario normal? <a href="../usuario/iniciar_sesion_usuario">
                                                    Iniciar sesión
                                                </a>
                                            </p>
                                            <p>
                                                Si eres una empresa y quieres aparecer en SAMAS home
                                                ponte en contacto con nosotros y te daremos una cuenta de acceso.
                                            </p>
                                        </div>
                                    </form>
                                </div>
