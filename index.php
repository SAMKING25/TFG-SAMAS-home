...
<head>
    ...
    <!-- Conexion con la base de datos y manejo de sesión -->
    <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_to_cart"])) {
        ...
        if ($cantidad < 1) {
            ...
            // Inserta o actualiza la cantidad en el carrito
...
<body class="navbar-home-body">
    ...
    <div class="container">
        ...
        <div class="container mt-5">
            ...
            <?php
            // Consulta para obtener productos en oferta (máximo 8 aleatorios)
            ...
            <div class="container my-5">
                ...
                <div class="categorias-scroll d-flex flex-row gap-4 overflow-auto pb-3">
                    <?php
                    // Consulta para mostrar todas las categorías
            ...
            <?php
            // Lógica para mostrar más o menos productos nuevos
            ...
            // Consulta para productos nuevos (sin oferta)
            ...
            <div class="container py-5 mt-5">
                ...
                <div class="nuevos-productos-grid">
                    ...
                    <!-- SweetAlert2 para mostrar el mensaje toast al añadir al carrito -->
                    ...
                    <?php
                    // Bucle para mostrar los productos nuevos
                ...
                <!-- Botón "Ver más productos" (añade 4 productos más a la vista) -->
    ...
    <script>
        // Script para animación de paneles (si se usan en la página)
    ...
    <script>
        // Cambia el favicon según el tema del sistema (oscuro o claro)
