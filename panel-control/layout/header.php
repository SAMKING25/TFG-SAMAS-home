    ...
    <div class="dropdown text-end col-12 col-md-3 justify-content-center">
      <a href="#" class=" align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
        <?php while ($fila = $resultado->fetch_assoc()) { ?>
            <img src="<?php echo IMG_USUARIO.$fila['foto_proveedor']?>" alt="" width="32" height="32" class="rounded-circle me-2">
            <strong><?php echo $fila['nombre_proveedor']?></strong>
        <?php } ?>
      </a>
      <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser1">
        <li><a class="dropdown-item" href="<?php echo USUARIO?>proveedor/cambiar_credenciales_proveedor.php">Perfil</a></li>
